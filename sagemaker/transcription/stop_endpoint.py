"""
stop_endpoint.py — Delete the Whisper SageMaker endpoint to stop billing.

Run this after a demo or test session:
    python sagemaker/stop_endpoint.py
...
def stop():
    ...
    print("\nDone. Add a # before SAGEMAKER_ENDPOINT_NAME in .env to use local model.")
    print("Re-deploy any time with: python sagemaker/start_endpoint.py")
